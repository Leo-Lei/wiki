...
### 修改iptables的FORWARD chain策略为ACCEPT
将iptables FORWARD chain的策略设置为ACCEPT
```bash
...
$ kubectl get nodes
NAME            STATUS    AGE       VERSION
192.168.5.101   Ready     8d        v1.6.2
192.168.5.102   Ready     8d        v1.6.2
```
都为 Ready 时正常。
...
nginx-ds-6ktz8              1/1       Running            0          5m        172.30.25.19   192.168.5.101
nginx-ds-6ktz9              1/1       Running            0          5m        172.30.20.20   192.168.5.102
```
